...
class App_KernelDevDebugContainer extends Container
{
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('eqf3vyuWJK', 0, ($this->targetDir.''.'/pools'), new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL));
    ...
    {
        return $this->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('ff4OvQb2C4', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    /**
     * Gets the private '.service_locator.gugsHR6' shared service.
     *
     * @return \Symfony\Component\DependencyInjection\ServiceLocator
     */
    protected function get_ServiceLocator_GugsHR6Service()
    {
        return $this->privates['.service_locator.gugsHR6'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
    ...
    {
        return $this->privates['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('pLRUqyjAXo', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.property_info'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('NpJwp3N2xf', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.security_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('4B3RXzwibN', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('QhDG5lDHBa', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('nZn7gctywL', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.webpack_encore'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('4kg8RygMPf', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    protected function getDebug_ArgumentResolver_NotTaggedControllerService()
    {
        ...
        return $this->privates['debug.argument_resolver.not_tagged_controller'] = new \Symfony\Component\HttpKernel\Controller\ArgumentResolver\TraceableValueResolver(new \Symfony\Component\HttpKernel\Controller\ArgumentResolver\NotTaggedControllerValueResolver(($this->privates['.service_locator.gugsHR6'] ?? $this->get_ServiceLocator_GugsHR6Service())), ($this->privates['debug.stopwatch'] ?? ($this->privates['debug.stopwatch'] = new \Symfony\Component\Stopwatch\Stopwatch(true))));
    }
        ...
        return [
            ...
            'team' => [
                'member_1' => [
                    'lastname' => 'Nicolas',
                    'firstname' => 'Richard',
                    'avatar' => '/build/images/avatars/bruce-wayne.png',
                    'job' => [
                        'en' => 'CO-Founder (CEO)',
                        'fr' => 'CO-Fondateur (CEO)',
                    ],
            ...
            'features' => [
                'item_1' => [
                    ...
                    'text' => [
                        'en' => 'Own and protect your own data.',
                        'fr' => 'Posséder et protéger vos propres données.',
                    ],
                ],
                'item_2' => [
                    'icon' => 'messages',
                ...
                'item_4' => [
                    ...
                    'title' => [
                        ...
                        'fr' => 'Transactions basées sur la blockchain',
                    ],
                    'text' => [
                        'en' => 'Funds are escrowed on our marketplace smart contract.',
                        'fr' => 'Les fonds sont bloqués sur notre contrat intelligent de marché.',
                    ],
                ],
            ],
            'milestones' => [
                'item_1' => [
                    ...
                    'text' => [
                        'en' => 'Claw drapes jump five feet high and sideways when a shadow moves.',
                        'fr' => 'Claw drapes jump five feet high and sideways when a shadow moves.',
                    ],
                ],
                'item_2' => [
                    'date' => [
                    ...
                    'text' => [
                        'en' => '<p>Scratch the furniture love you, while flying in a toasted bread costume.</p> <p class="mb-0">My water bowl is clean and freshly replenished, so i\'ll drink from the toilet cat mojo and gimme attention.</p>',
                        'fr' => '<p>Scratch the furniture love you, while flying in a toasted bread costume.</p> <p class="mb-0">My water bowl is clean and freshly replenished, so i\'ll drink from the toilet cat mojo and gimme attention.</p>',
                    ],
                ],
                'item_3' => [
                    'is_old' => true,
                    ...
                    'text' => [
                        'en' => 'Lorem ipsum dor amet sir.',
                        'fr' => 'Lorem ipsum dor amet sir.',
                    ],
                ],
            ],
